...
<head>
  ...
  <title>SPV Desktop - Studio SPH & Quotation Penawaran</title>
  <meta name="description" content="Penerbitan dan review Surat Penawaran Harga (SPH) resmi Toyota Tunas Kiara Condong oleh Supervisor." />
  ...
  <style>
    .spv-sph-toolbar {
      ...
      align-items: center;
      background: linear-gradient(135deg, rgba(16, 24, 40, 0.95) 0%, rgba(11, 17, 32, 0.98) 100%);
...
<body>
  <div class="spv-shell theme-spv">
    ...
    <aside class="spv-sidebar">
      ...
      <nav class="spv-nav">
        ...
        <a href="quotation.html" id="navSph" class="active"><i class="fa-solid fa-file-invoice-dollar"></i>Studio SPH &amp; Quotation <span class="sidebar-notif-badge" style="background:#0284c7; color:#fff; display:inline-block; margin-left:auto; font-size:9px; padding:1px 5px; border-radius:4px; font-weight:800;">A4 PDF</span></a>
    ...
    <main class="spv-main">
      ...
      <div class="spv-topbar">
        <div>
          <h2 id="pageTitle">Studio SPH &amp; Digital Quotation</h2>
          <p class="page-sub">Review simulasi cicilan kredit, diskon penawaran, serta penerbitan SPH resmi untuk tim wiraniaga</p>
        </div>
        <div class="spv-user">
      ...
      <div class="spv-sph-toolbar">
        <div class="spv-sph-badge">
          <i class="fa-solid fa-user-tie"></i>
          <span>Portal Supervisi Tim Wiraniaga &bull; Tunas Toyota Kiara Condong</span>
        </div>
        <div class="spv-sph-actions">
          <button type="button" class="btn-sph-spv btn-sph-copy" onclick="copyQuotationText()" title="Salin Ringkasan Teks">
            <i class="fa-solid fa-copy"></i> Salin Teks
          </button>
          <button type="button" class="btn-sph-spv btn-sph-wa" onclick="shareQuotationWA()" title="Kirim via WhatsApp">
            <i class="fa-brands fa-whatsapp"></i> Kirim WhatsApp
          </button>
          <button type="button" class="btn-sph-spv btn-sph-print" onclick="printQuotation()" title="Cetak atau Unduh Dokumen PDF Resmi">
      ...
      <div class="sph-workspace view-builder" style="padding-top:0;">
        ...
        <section class="sph-builder-card">
          <div class="sph-card-header">
            ...
            <span class="sph-pill-tag">OFFICIAL SPV QUOTATION</span>
          </div>
          ...
          <div class="sph-card-body">
            ...
            <div id="sectionBuilderCash" style="display:none;">
              <p style="font-size:12px; color:#cbd5e1; line-height:1.5; margin-bottom:12px; background:rgba(255,255,255,0.04); padding:10px; border-radius:8px; border-left:3px solid #38bdf8;">
        ...
        <section class="sph-preview-container">
          <div class="sph-paper" id="sphPrintArea">
            ...
            <div class="sph-doc-title-block">
              ...
              <div style="margin-top:4px;"><span style="font-size:10px; font-weight:800; color:#0369a1; background:#e0f2fe; padding:2px 8px; border-radius:4px; border:1px solid #bae6fd;"><i class="fa-solid fa-check"></i> TELAH DIREVIEW SUPERVISOR PENJUALAN</span></div>
            </div>
            ...
            <div class="sph-sign-row">
              ...
              <div class="sph-sign-box" style="border:1.5px solid rgba(56,189,248,0.4); background:#f0f9ff;">
                <div class="sph-sign-title" style="color:#0369a1; font-weight:800;">Mengetahui / Review:</div>
                <div class="sph-sign-name" id="docSignSpvName" style="color:#0c4a6e; font-weight:800;">Supervisor Penjualan</div>
                <div class="sph-sign-role" style="color:#0369a1; font-weight:700;">Tunas Toyota Kiara Condong</div>
              </div>
              <div class="sph-sign-box">
                <div class="sph-sign-title">Disetujui:</div>
                <div class="sph-sign-name">Kepala Cabang</div>
                <div class="sph-sign-role">Branch Manager Kiara Condong</div>
              </div>
              <div class="sph-sign-box">
                <div class="sph-sign-title">Disetujui Konsumen:</div>
  ...
  <script src="../js/quotation.js?v=20260915_spv_v2"></script>
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      const elSignSpv = document.getElementById('docSignSpvName');
      if (elSignSpv && spvNama && spvNama !== 'Sales') elSignSpv.textContent = spvNama;
