  ...
  <div class="spv-shell">
    ...
    <aside class="spv-sidebar">
      ...
      <nav class="spv-nav">
        ...
        <a href="followup_database.html" id="navFollowup" class="active"><i class="fa-solid fa-bullhorn"></i>Database Follow-Up</a>
    ...
    <main class="spv-main">
      <div class="spv-topbar">
        <div>
          <h2>Master Database Follow-Up Customer</h2>
          <p class="page-sub">Kelola data pembeli mobil, bagi tugas follow-up ke wiraniaga, dan monitor progres closing</p>
        </div>
        <div class="spv-user">
      ...
      <div class="kpi-grid-5">
        <div class="kpi-card card-blue">
          ...
          <div class="fu-kpi-sub">
            <span class="fu-badge-pill pill-blue"><i class="fa-solid fa-building"></i> Tim Supervisi</span>
          </div>
        </div>
      ...
      <div id="bulkActionBar" style="display:none; background:linear-gradient(135deg, #0d1b3e 0%, #16305f 100%); color:#ffffff; padding:14px 20px; border-radius:16px; margin-bottom:18px; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:12px; box-shadow:0 10px 30px rgba(13,27,62,0.35);">
      ...
      <div style="background:linear-gradient(135deg, #f0fdf4 0%, #dcfce7 100%); border:1.5px solid #bbf7d0; border-radius:16px; padding:12px 18px; margin-bottom:18px; display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:10px;">
        <div style="display:flex; align-items:center; gap:10px; font-size:13px; font-weight:800; color:#166534;">
          <div style="width:36px; height:36px; border-radius:10px; background:#10b981; color:#ffffff; display:flex; align-items:center; justify-content:center; font-size:18px; box-shadow:0 4px 10px rgba(16,185,129,0.3);">
            <i class="fa-brands fa-whatsapp"></i>
          </div>
          <div>
            <div style="line-height:1.2;">Kirim Instruksi Tugas ke WhatsApp Sales:</div>
            <div style="font-size:11px; color:#15803d; font-weight:600;">Kirim ringkasan nama &amp; kontak customer langsung ke chat WA wiraniaga</div>
          </div>
        </div>
        <div style="display:flex; align-items:center; gap:8px;">
          <select id="assignTaskSalesSelect" class="fu-select" style="width:auto; padding:8px 14px; font-size:12px; font-weight:700; background:#ffffff;">
          </select>
          <button class="btn-fu btn-fu-emerald" onclick="sendTaskNotificationToSales(document.getElementById('assignTaskSalesSelect').value)">
            <i class="fa-solid fa-paper-plane"></i> Kirim Tugas via WA
          </button>
        </div>
      </div>
      ...
      <div class="followup-table-wrap">
        <div style="padding:12px 16px; border-bottom:1.5px solid #e2e8f0; display:flex; justify-content:space-between; align-items:center; background:#f8fafc;">
          <h3 style="font-size:13.5px; font-weight:800; color:#0f172a; margin:0;">Database Customer Follow-Up</h3>
