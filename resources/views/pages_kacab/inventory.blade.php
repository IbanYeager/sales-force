...
<head>
  ...
  <title>Kacab Desktop - Live Inventory & Stok Toyota</title>
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
  <link rel="stylesheet" href="../css/style_kacab.css">
  <link rel="stylesheet" href="../css/inventory.css?v=20260819_kacab">
  ...
  <div class="kcb-shell">
    ...
    <aside class="kcb-sidebar">
      ...
      <nav class="kcb-nav">
        ...
        <a href="inventory.html" id="navStock" class="active"><i class="fa-solid fa-warehouse"></i>Live Stok (1.638 Unit)</a>
      ...
      <div style="margin-top: 10px;">
        ...
        <div class="inv-top-card">
          <div class="inv-header-row">
            <div>
              <h3 class="inv-title">
                <i class="fa-solid fa-boxes-stacked" style="color: var(--amber, #b45309); margin-right: 8px;"></i>
          ...
          <div class="inv-toolbar-right">
            ...
            <div class="view-mode-switcher">
              <button class="view-btn active" id="viewBtnTable" onclick="switchViewMode('table')"
                title="Tampilan Tabel Ringkas (Padat &amp; Rapi)">
              ...
              <button class="view-btn" id="viewBtnAccordion" onclick="switchViewMode('accordion')"
                title="Tampilan Grup Model (Bisa Dilipat)">
        ...
        <div id="inventoryList" class="inventory-render-wrapper view-table">
          <div style="text-align: center; padding: 50px 0; color: var(--text-muted, #64748b); font-size: 14px;">
            <i class="fa-solid fa-circle-notch fa-spin"
              style="font-size:24px; color:var(--amber, #b45309); margin-bottom:10px; display:block;"></i>
