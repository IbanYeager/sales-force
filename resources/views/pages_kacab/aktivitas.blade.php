...
<head>
  ...
  <link rel="stylesheet" href="../css/style_kacab.css?v=20260909_master_v5">
...
<body>
    ...
    <main class="kcb-main">
      <div class="kcb-topbar">
        <div>
          ...
          <p class="page-sub">Timeline aktivitas harian seluruh sales cabang</p>
        </div>
        <div class="kcb-user">
      ...
      <div class="kcb-card">
        <div class="toolbar">
          <div class="search-box">
            ...
            <input type="text" id="searchActivity" placeholder="Cari nama sales, keterangan, atau lokasi..."
              oninput="applyTimelineFilters()">
          </div>
          <div class="select-box">
            <i class="fa-solid fa-user-tie"></i>
            <select id="filterSpv" onchange="applyTimelineFilters()">
  ...
  <script src="../js/kacab_aktivitas.js?v=20260909_master_v8"></script>
