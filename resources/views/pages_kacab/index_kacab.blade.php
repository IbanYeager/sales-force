...
<body>
  <div class="kcb-shell">
    ...
    <main class="kcb-main">
      ...
      <!-- ===== OPERASIONAL, AO REPORT & AI SENTINEL CABANG ===== -->
      <div id="section-ops-dashboard">
        ...
        <section class="kcb-card" id="aiSentinelContainer" style="background:#ffffff; border:1px solid #e2e8f0; border-radius:16px; padding:20px; box-shadow:0 4px 18px rgba(0,0,0,0.04); margin-bottom:20px;">
          ...
          <div id="sentinelListContainer">
            <p class="loading-state" style="padding:15px;"><i class="fa-solid fa-spinner fa-spin"></i> AI sedang menganalisis seluruh data wiraniaga cabang...</p>
          </div>
        </section>
