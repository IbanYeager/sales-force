  ...
  <div class="kcb-shell">
    ...
    <main class="kcb-main">
      ...
      <section class="spv-card">
        <div class="card-head">
          <div>
            <h1 class="title" style="font-size:18px; font-weight:800; color:#0f172a; margin:0;"><i class="fa-solid fa-users" style="color:#d7123a; margin-right:8px;"></i> Seluruh Wiraniaga Cabang</h1>
